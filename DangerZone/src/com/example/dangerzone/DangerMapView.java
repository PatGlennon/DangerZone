...
public class DangerMapView extends MapView {
...
private DangerMapView.OnLongpressListener longpressListener;

 
public DangerMapView(Context context, String apiKey) {
    super(context, apiKey);
}

public DangerMapView(Context context, AttributeSet attrs) {
    super(context, attrs);
}

public DangerMapView(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
}

public void setOnLongpressListener(DangerMapView.OnLongpressListener listener) {
    ...
    if (event.getAction() == MotionEvent.ACTION_DOWN) {
        ...
        longpressTimer.schedule(new TimerTask() {
            ...
            public void run() {
                 ...
                 * by the caller.
                 */
                longpressListener.onLongpress(DangerMapView.this, longpressLocation);
            }
